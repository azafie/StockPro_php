...
-- StockPro · Banco de Dados (MySQL 8+)
-- Versão: v1.0 (DDL + seeds + views)
-- Compatível com MySQL 8.0.20+
-- Charset/Collation recomendados: utf8mb4 / utf8mb4_0900_ai_ci
...
-- ========================================================
-- Database (opcional crie conforme sua instância)
-- CREATE DATABASE stockpro DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
-- USE stockpro;

-- ========================================================
-- Tabelas e Tipos (ENUMs inline)
-- ========================================================
...
-- Opcional: busca por nome (MySQL 8 permite FULLTEXT em InnoDB)
...
CREATE TABLE IF NOT EXISTS movimentacoes (
  ...
  produto_id BIGINT UNSIGNED NOT NULL,
  local_id BIGINT UNSIGNED NULL,
  quantidade INT NOT NULL, -- convensão: entradas/ajustes positivas; saídas positivas e subtraídas nas views
...
-- Produtos abaixo do mínimo (soma total em todos os locais)
...
-- ========================================================
-- Seeds (dados fictícios alinhados ao frontend)
-- Use INSERT IGNORE para não duplicar em execuções repetidas
-- ========================================================
...
INSERT IGNORE INTO produtos (id, sku, nome, categoria_id, unidade, preco, estoque_min, status, descricao)
VALUES
...
-- Movimentações do dashboard de exemplo
...
-- Ajuste -2 Mouse Óptico (usando ajuste como negativo para exemplo)
INSERT INTO movimentacoes (data_mov, tipo, produto_id, local_id, quantidade, origem, observacoes, ref_tabela)
